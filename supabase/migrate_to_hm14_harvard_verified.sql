...
-- ========================================
-- If you want to keep history, export data first:
-- SELECT * FROM student_projects WHERE ticker IS NOT NULL;
-- SELECT * FROM pitch_market_data;
-- SELECT * FROM user_investments;
-- SELECT * FROM investment_transactions;

-- ========================================
-- STEP 2: DELETE NON-HARVARD AND EXISTING HM14 COMPANIES
-- ========================================
...
-- ========================================
-- STEP 3: RESET ALL USER INVESTMENTS
-- ========================================
...
-- Clear AI trading logs (optional - keeps historical data)
...
-- ========================================
-- STEP 4: INSERT NEW HM14 COMPANIES
-- ========================================

-- pitch_id 1 = META (keep existing)
-- pitch_id 2 = MSFT (keep existing)
-- pitch_id 3-14 = New Harvard companies
...
-- ========================================
-- STEP 5: INITIALIZE MARKET DATA
-- ========================================

-- Insert market data for all 14 companies (will be updated by cron)
...
-- ========================================
-- STEP 6: UPDATE AI_READABLE_PITCHES VIEW
-- ========================================

-- Drop and recreate the view to include all 14 companies
...
SELECT ai_nickname, available_tokens, portfolio_value
...
SELECT COUNT(*) as investment_count FROM user_investments;
