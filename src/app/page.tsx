        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          {user ? (
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-xl border border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="py-2">
